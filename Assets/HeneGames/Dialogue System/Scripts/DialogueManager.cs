...
namespace HeneGames.DialogueSystem
{
    public class DialogueManager : MonoBehaviour
    {
        ...
        private void ShowCurrentSentence()
        {
            ...
            {
                if (sentences[currentSentence].emotion != null)
                {
                    //Show sentence with custom emotion on the screen
                    DialogueUI.instance.ShowSentence(sentences[currentSentence].emotion, sentences[currentSentence].dialogueCharacter, sentences[currentSentence].sentence);
                }
                else
                {
